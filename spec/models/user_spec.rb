...
describe User do
 ...
 # it { should be_valid }
  ...
  describe "when the email is not presence" do
    before {@user.email = ""}
    it {should_not be_valid}
  end
  ...
  describe "the email format is valid" do
  ...
  describe "when password is not persencee" do
    before do
      @user = User.new(:name => "yh",
      :email => "yh@yh.com",
      :password => " ",
    ...
    describe "when password is not persent" do
      before do
        @user = User.new(name: "yh",
        email: "yh@yh.com",
        password: " ",
...
describe "when password doesn't match confirmation" do
  before {@user.password_confirmation = "dfdf"}
  it{should_not be_valid}
end
...
describe "return value of authenticatemethod" do
  before{ @user.save }
